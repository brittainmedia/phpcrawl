...
class PHPCrawler
{
     ...
     */
    protected $porcess_abort_reason;
     ...
     * @var int
     */
    protected $child_process_number;
     ...
     */
    protected $CrawlerStatusHandler;
     ...
     * @throws Exception
     */
    public function goMultiProcessed($process_count = 3, $multiprocess_mode = 1): void
    {
     ...
     * @throws Exception
     */
    public function goMultiProcessedLinux($process_count = 3, $multiprocess_mode = 1): void
    {
     ...
     */
    public function addLinkPriority($regex, $level): ?bool
    {
     ...
     * @section 10 Other settings
     */
    public function setFollowRedirects($mode): bool
    {
     ...
     * @section 10 Other settings
     */
    public function setFollowRedirectsTillContent($mode): void
    {
     ...
     * @section 1 Basic settings
     */
    public function setFollowMode($follow_mode): bool
    {
        // Check mode
     ...
     */
    public function addContentTypeReceiveRule($regex): bool
    {
     ...
     * @section 2 Filter-settings
     */
    public function obeyRobotsTxt($mode, $robots_txt_uri = null): bool
    {
        if (!is_bool($mode)) {
            return false;
        }
     ...
     */
    public function setRequestLimit($limit, $only_count_received_documents = false): bool
    {
     ...
     * @section 5 Limit-settings
     */
    public function setTrafficLimit($bytes, $complete_requested_files = true): ?bool
    {
     ...
     * @section 10 Other settings
     */
    public function enableCookieHandling($mode): bool
    {
        if (!is_bool($mode)) {
            return false;
        }
     ...
     * @return bool
     */
    public function setUserAgentString($user_agent): bool
    {
     ...
     * @section 1 Basic settings
     */
    public function setWorkingDirectory($directory): ?bool
    {
        if (is_writable($this->working_base_directory)) {
     ...
     * @section 10 Other settings
     */
    public function setStreamTimeout($timeout): ?bool
    {
        if (preg_match('#[0-9]+#', $timeout)) {
     ...
     * @section 1 Basic settings
     */
    public function setUrlCacheType($url_cache_type): ?bool
    {
     ...
     * @section 2 Filter-settings
     */
    public function obeyNoFollowTags($mode): void
    {
     ...
     * @section 5 Limit-settings
     */
    public function setRequestDelay($time): bool
    {
     ...
     * @return bool
     */
    public function setCrawlingDepthLimit($depth): bool
    {
